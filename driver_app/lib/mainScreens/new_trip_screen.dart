                      ...
                      async {
                          if(rideRequestStatus == "accepted") //driver has arrived at user pickup location
                          {
                            rideRequestStatus = "arrived";
                              ...
                              //user barrierDismissible, allows to not close the progress bar, by clicking outsite, as we want to do till below await returns a value
                              showDialog(
                                context: context,
                              ...
                              //Go to step 2 ( userpickup to userDropoff
                          ...
                          //Else if means , user is in driver car , so do step(2)
                          else if(rideRequestStatus == "arrived") //driver has arrived at user pickup location
                              {
