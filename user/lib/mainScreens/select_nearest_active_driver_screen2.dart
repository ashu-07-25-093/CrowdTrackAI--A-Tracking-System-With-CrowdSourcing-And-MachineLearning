...
class SelectNearestActiveDriversScreenTwo extends StatefulWidget
{
  DatabaseReference? referenceRideRequest;
  SelectNearestActiveDriversScreenTwo({this.referenceRideRequest});

  @override
  _SelectNearestActiveDriversScreenStateTwo createState() => _SelectNearestActiveDriversScreenStateTwo();
}



class _SelectNearestActiveDriversScreenStateTwo extends State<SelectNearestActiveDriversScreenTwo>
{
  ...
  fun(String s)
  {
    ...
    return "Route : " + s.substring(0,idx) + " , Id = " + s.substring(idx+1,lidx) + "  \nFrom = " + s.substring(lidx+1);
