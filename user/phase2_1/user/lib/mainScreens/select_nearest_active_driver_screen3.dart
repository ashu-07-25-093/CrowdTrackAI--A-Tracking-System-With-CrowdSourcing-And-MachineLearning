    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(children: [
          ...
          ListView.builder(
            itemCount: BusListFortopThreeDynamicdrivers.length,
            itemBuilder: (BuildContext context, int index)
            {
              return GestureDetector(
                ...
                async {
                  ...
                  await Navigator.push(context, MaterialPageRoute(builder: (c)=> MainScreenTwo()));
                ...
                child: Card(
                  ...
                  child: ListTile(
                    ...
                    title: Column(
                      ...
                      children: [
                        Text(
                          fun2(BusListFortopThreeDynamicdrivers[index] , BusListFortopThreeDynamicdriversRoutes[index] , TimeFortopThreeDynamicdriversRoutes[index]),
                          // "hihi",
                          style: const TextStyle(
                            fontSize: 14,
